...
_test_running_time="60"; # 1 minutes
...
test_ssdcache_randomrw_r2w2()
{
_test_func="b05_hdd_randrw.$(tstamp)"
_wl_name="wl.randomrw_r2w2_${_tname}";	# _tname ::= "fs250mb" | "fs500mb" | "fs1gb" | "fs2gb" | "fs4gb" | "fs8gb"
_mntdir=".mnt/sdc1";
...
#_test_title="$_test_func" _tcase_id="fs250mb" _target_dev="sdc" _fb_run_time="$_test_running_time" _fb_workload="wl.randomrw_r2w2_fs250mb" ..fb_exec_core.sh;
#_test_title="$_test_func" _tcase_id="fs500mb" _target_dev="sdc" _fb_run_time="$_test_running_time" _fb_workload="wl.randomrw_r2w2_fs500mb" ..fb_exec_core.sh;
#_test_title="$_test_func" _tcase_id="fs1gb" _target_dev="sdc" _fb_run_time="$_test_running_time" _fb_workload="wl.randomrw_r2w2_fs1gb" ..fb_exec_core.sh;
#_test_title="$_test_func" _tcase_id="fs2gb" _target_dev="sdc" _fb_run_time="$_test_running_time" _fb_workload="wl.randomrw_r2w2_fs2gb" ..fb_exec_core.sh;
#_test_title="$_test_func" _tcase_id="fs4gb" _target_dev="sdc" _fb_run_time="$_test_running_time" _fb_workload="wl.randomrw_r2w2_fs4gb" ..fb_exec_core.sh;
#_test_title="$_test_func" _tcase_id="fs8gb" _target_dev="sdc" _fb_run_time="$_test_running_time" _fb_workload="wl.randomrw_r2w2_fs8gb" ..fb_exec_core.sh;
}
