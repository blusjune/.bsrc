/**
 * @file microbench.h
 * @brief Headers for the benchmark module
 */
/*
 ...
 * @return a pointer to a structure containing benchmark results for this session
 */
UflipResults *runBench (UflipParams *PB);
